...
public class HiddenMediaAdapter extends RecyclerView.Adapter<HiddenMediaAdapter.ViewHolder> {
    ...
    public HiddenMediaAdapter(Context context, List<File> effectsList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        Bitmap rotatedBitMap = ImageRotationUtil.rotatedBitmap(hiddenImagesList.get(position).getAbsolutePath(), myBitmap);
